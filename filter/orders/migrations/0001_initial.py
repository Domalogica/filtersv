# Generated by Django 2.0.7 on 2018-09-17 09:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postal_code', models.CharField(blank=True, max_length=20, null=True, verbose_name='Почтовый код')),
                ('city', models.CharField(blank=True, max_length=100, null=True, verbose_name='Город')),
                ('comment', models.TextField(blank=True, null=True, verbose_name='Комментарий')),
                ('installments', models.BooleanField(default=False, verbose_name='Рассрочка')),
